...
<?php 
echo "<tr>参数:?userid=2519273&gameid=911&lobbyId=101&
		spServerIp=10.48.179.103&spServerPort=8901&
...
foreach ($ARR as $rel){
	...
	print "|";
	$url = $rel->attributes['URL'].'?userid=2519273&gameid=911&lobbyId=101&spServerIp=10.48.179.103&spServerPort=8901&spServiceHTTPUrl=http://10.48.179.115:882/yunbi';
